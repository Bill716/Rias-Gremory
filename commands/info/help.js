...
function getAll(client, message) {
    const embed = new MessageEmbed()
        .setColor("#FFDFD3")
        .setThumbnail("https://cdn.discordapp.com/app-icons/900279926874316871/510058fde6e6c9f172bf81fb61d0215e.png?size=256")
        .setTitle('Help Menu')
        .setURL('https://github.com/Bill716/Rias-Gremory')
